...
-----------------------
  ...
  ---------- ---------------------------------------------------- -------------------------------------------
  **偏移**   **内容**                                             **用途**
  0x100f     CTF_ZKP_FLAG_V2                                   Flag 计算前缀
  0x1053     CTF_ZKP_INTERMEDIATE_SEED_V2                     intermediate_token 盐值
  0x13a5     CTF_ZKP_apk-13_SALT_V3                           session_ctx HKDF 盐值
  0x13d2     k3y_j4va_k3y!!!!                                   username XOR 常量（截取 _j4va_k3y!!!!）
  0x13e5     \\x11\\x58\\x09\\x00\\x07\\x55\\x05\\x15\\x3a\\x19   username XOR 密钥（10 字节）
  0xfe6      AUTH_OK                                             HKDF info 参数
  0x10eb     t1_static_                                         key1 前缀
  0x12bf     2_dynamic_\\0                                      key2 前缀（含 null）
  0x13bc     t3_android_                                        key3 前缀
  0x1388     Zkp_\\0                                             密码第一部分
  0x11a2     M_as\\0                                             密码第二部分
...
PRK = HMAC-SHA256(key=salt_hash, data=password_hash)
  ...
  ---------------- ------------------------------------------------------------------
  **值**           **哈希**
  salt_hash       86e456a838cae42cf0ca33bda4e0a42f0b92c264a1acc68d8a161a7450eeac90
  password_hash   8f8f0869d7d2232f46ad5974aa66e4701534ac18697f62b45bff942cb22b63c1
